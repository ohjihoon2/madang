	...
	<div>
		<div id="left_nav">
			<ul>
				...
				<li><a style="color: rgb(5, 135, 94)" href="#">예매내역 확인</a></li>
		...
		<div>
			<button type="button" id="mem_out_btn">탈퇴</button>
