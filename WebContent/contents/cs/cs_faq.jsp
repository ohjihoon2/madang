			...
			<ul>
				...
				<li>
					...
					<div class="faq_slide" id="f10">
						...
						<br>
						<br>명절연휴 등은 각 전시별로 운영여부가 다르므로 예술의마당 홈페이지 또는 전시 주최측에 문의해 주시기 바랍니다.
					</div>
				</li>
				<br>
				...
				<li>
					...
					<div class="faq_slide" id="f14">
						티켓예매 서비스는 예술의마당 회원으로 가입하신 후 이용이 가능하며, 
						<br>[공연] 및 [전시]에서 각 공연과 전시의 정보 확인과 함께 예매 서비스를 이용하실 수 있습니다.
					</div>
				</li>
				<br>
				...
				<li>
					...
					<div class="faq_slide" id="f15">
						QR코드 티켓 수령 시
						<br>예술의마당 홈페이지 내 [마이페이지]를 통해 예매내역을 직접 취소하실 수 있으며
						<br>예술의마당에 직접 전화하여 환불하실 수도 있습니다.
						<br>(02-2019-2020, 09:00~18:00)
						<br>
						<br>티켓 현장수령 시
				...
				<!-- <li> 예매 취소시 바로 데이터 삭제 예정이라 이거 지울 예정
					<div>
						<span class="faq_list_category">환불/취소</span>
