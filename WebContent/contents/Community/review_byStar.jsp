...
<body>
	...
	<div>
		...
		<div id="review_content">
			<div id="sub_title">
				관람후기
				<a href="http://211.63.89.214:9090/contents/Community/review_byDate.jsp"><button type="button" id="btnByDate" style="background:white;color:rgb(5, 135, 94)">최신날짜순</button></a>
				<a href="http://211.63.89.214:9090/contents/Community/review_byStar.jsp"><button type="button" id="btnByStar" style="background:rgb(5, 135, 94);color:white">평점높은순</button></a>
			</div>
			<div class="table_div">
			<%for(int i = 1; i < 8; i++){ %>
