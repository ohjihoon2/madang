...
<body>
	...
	<div class="concert_button">
		<a href="exhibition_view_picasso.jsp"><button type="button" class="btn_hall">피카소 관</button></a>
		<a href="exhibition_view_davinci.jsp "><button type="button" class="btn_hall" style="background:rgb(5,135,94)">다빈치 관</button></a>
		<a href="exhibition_view_jihoon.jsp "><button type="button" class="btn_hall">오지훈 관</button></a>
	</div>
	<div class="exhibition_view">
		<h1>다빈치 홀</h1>
		<img src="http://211.63.89.214:9090/images/exhibition/han_design_1.gif">
		<img src="http://211.63.89.214:9090/images/exhibition/han_design_map.png">
	</div>
