...
<body>
	...
	<div class="concert_button">
		<a href="concert_seat_beethoven.jsp"><button type="button" class="btn_hall" style="background:rgb(5,135,94)">베토벤홀</button></a>
		<a href="concert_seat_mozart.jsp"><button type="button" class="btn_hall">모짜르트홀</button></a>
	</div>
	<div class="concert_seat_guide">
		<h1>베토벤 홀</h1>
		<img src="http://211.63.89.214:9090/images/concert_main/concert_seat2_pic.jpg">
		<div>
			<h2>공연장 좌석배치도<br>
		...
		<img src="http://211.63.89.214:9090/images/concert_main/concert_seat2.gif">
	</div>
