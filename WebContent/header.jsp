...
<body>
	...
	<div class="header_nav">
		...
		<% if(generalId==null && groupId==null){ %>
			...
			<li><a href="http://211.63.89.214:9090/contents/mypage/mypage_main.jsp">마이페이지</a></li>		<!-- 막아버리기 -->
		...
		<%}else if(generalId==null && groupId!=null){ %>
			...
			<li><a href="http://211.63.89.214:9090/contents/login/logout_proce.jsp">로그아웃</a></li>
			<!-- <li><a href="http://211.63.89.214:9090/contents/join/join0.jsp">회원가입</a></li> -->
			<li><a href="http://211.63.89.214:9090/contents/mypage/mypage_main_group.jsp">마이페이지</a></li>
			<li><a href="#">티켓예매</a></li>
			<li><a href="http://211.63.89.214:9090/contents/cs/cs_main.jsp">고객센터</a></li>
		<%} %>
		</nav>
		...
		<div class="container">
			<ul class="dept01">
				...
				<li class="ticket">
					...
					<ul class="dept02">
						<li><a href="#">티켓예매</a></li>
						<li><a href="http://211.63.89.214:9090/contents/ticket/respecting_ticket.jsp">우대안내</a></li>
					</ul>
				</li>
